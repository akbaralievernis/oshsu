            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6 md:p-8 rounded-3xl dark:bg-slate-900/30 bg-white border dark:border-slate-900 border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full flex items-center justify-center gap-2.5 py-3.5 dark:bg-slate-955 bg-slate-100 hover:bg-slate-200 dark:hover:bg-slate-900 border dark:border-slate-800 border-slate-250 dark:text-slate-305 text-slate-700 font-semibold rounded-2xl transition-all duration-300 cursor-pointer">
        ...
        {activeTab === 'applications' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 dark:bg-slate-900/30 bg-white border dark:border-slate-900 border-slate-200 rounded-2xl shadow-sm">
              ...
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 dark:bg-slate-955 bg-slate-100 border dark:border-slate-800 border-slate-200 rounded-xl text-xs font-semibold hover:bg-slate-200 dark:hover:bg-slate-900 cursor-pointer">
            ...
            <div className="dark:bg-slate-900/30 bg-white border dark:border-slate-900 border-slate-200 rounded-3xl overflow-hidden shadow-sm">
              <div className="w-full overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[700px]">
                  <thead>
                    <tr className="dark:bg-slate-955/60 bg-slate-100/60 border-b dark:border-slate-900 border-slate-200 text-xs font-semibold text-slate-500 uppercase tracking-wider">
